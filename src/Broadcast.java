...
/**
 * A {@code Broadcast} stores a mapping from users to a list of responses. The
 * server backend uses a broadcast to send messages to clients to inform them of
 * relevant events in their channels. For instance, many chat services inform
 * you when someone has been removed from a chat that you're in.
 *
...
public final class Broadcast {
     ...
     *                   user's disconnection. Should not include the user who
     *                   disconnected.
     * @return A {@code Broadcast} representing the response to send
     */
     ...
     * user is added to a channel as the result of a {@link JoinCommand} or
     * {@link InviteCommand}. The resulting Broadcast informs the relevant client of
     * the nicknames of all other users in the channel.
     *
     ...
     *                   the user is joining, and to whom the command should be
     *                   relayed.
     ...
     *                                  {@link JoinCommand} or {@link InviteCommand}
     */
     ...
     * with the user IDs of the recipients. This * function will be called by the
     * {@link ServerBackend} before dispatching the {@code Broadcast}.
     * 
     * @param model A class conforming to {@link ServerModelApi} which can be used
     *              to look up user IDs.
     * @return a mapping from user ID to a list of response strings that should be
     *         delivered by the {@link ServerBackend}
     */
     ...
     * nickname of the channel's owner, and a collection of the nicknames of the
     * users in the channel (including the owner).
     * 
