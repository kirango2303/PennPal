 ...
 * messages. You can and should use these tests as a model for your own testing,
 * but write your tests in ServerModelTest.java.
 *
 * Note that "assert" commands used for testing can have a String as their last
...
public class ChannelsMessagesTest {
    ...
    public void testCreateNewChannel() {
        ...
        assertTrue(model.getUsersInChannel("java").contains("User0"), "channel has creator");
    ...
    public void testNickBroadcastsToChannelWhereMember() {
        ...
        assertFalse(model.getUsersInChannel("java").contains("User0"), "old nick not in channel");
        assertTrue(model.getUsersInChannel("java").contains("Duke"), "new nick is in channel");
        assertTrue(model.getUsersInChannel("java").contains("User1"), "unaffected user still in channel");
    }
    ...
    public void testDeregisterSendsDisconnectedWhereMember() {
        ...
        assertEquals(1, model.getUsersInChannel("java").size(), "num. users in channel");
        assertTrue(model.getUsersInChannel("java").contains("User0"), "unaffected user still in channel");
    }
